...
- Variables equations were added at the end of the **Descriptive analysis** section.
...
$$
\begin{equation} 
  \text{Cases per pop %} = \frac{\text{cases}}{\text{population}*100}
  \tag{2}
\end{equation}
$$
$$
\begin{equation} 
  \text{Deaths per pop %} = \frac{\text{deaths}}{\text{population}*100}
  \tag{3}
\end{equation}
$$
