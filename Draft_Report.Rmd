...
- **Aims** section containing the objectives of the project was added.
- **Code Availability** section was created containing the link for the github repository with the project code and documents.
- The data was updated at March, new information regarding COVID cases, deaths and vaccination was added.
- A correlation analysis was added at the end of the **Descriptive analysis** section.
- Minor changes regarding the model coefficients in the **Discussion** section.
- Minor typos correction.
- Figures and tables were updated, all axis labels and variables names fixed.
...
```
The cumulative cases overtime shows that Americas region had more cases than Europe until the beginning of 2022, showing a high increase in numbers of new cases in Europe in this period (Figure 2). At March 4th 2022, the Americas region has the highest cumulative deaths (2,637,306), 757,950 more deaths than Europe and 1,873,504 more deaths than South-East Asia.
...
```
The correlation between the analyzed variables (Table 3) showed a moderate positive correlation between vaccination rate, case rate, and GDP, and a weak positive correlation between vaccination rate and mortality rate. The mortality rate and case rate had a moderate positive correlation, and GDP had a moderate positive correlation with case rate and a weak positive correlation with mortality rate.
...
Each weight is inversely proportional to the error variance, where observations with small error variance will have large weight and the ones with large error variance will have small weight [7]. The model was chosen due to the presence of a continuous outcome and also because the WLS model deals with the heteroscedasticity issue that is common when applying Ordinary Least Squares models to complex real-world data.
...
To evaluate if there is an effect in country vaccination levels given cases, deaths and GDP, the WLS was fitted based on 181 countries and showed that for a unit increase in cases per population percentage represents a 0.609 increase in fully vaccinated population percentage. That result indicated that countries with more cases cases per population tends to have a greater percentage of population fully vaccinated by March 2022. The model also showed that a $10,000 increase in GDP represents a 4.873 increase in fully vaccinated population percentage, indicating how more wealth countries will have a greater percentage of population fully vaccinated by March 2022.
